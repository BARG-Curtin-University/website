...
In this week news, Sam Altman of OpenAI, chatGPT Plus uses getting browsing and plugins, LangGPT help you write quaity prompts, Google announces AI features will be added to Colab free of charge, OpenAI announces whisper, an open source speech-recognition system for voice input, OpenAI CEO Sam Altman testified before the Senate and DragGAN is released.
